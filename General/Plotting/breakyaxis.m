...
function breakInfo = breakyaxis(varargin)
   ...
   %%
    ...
    set(lowAxes,'Position', lowPosition, ...
        ...
        'XTickLabel', [], ...
        'box','off');
    delete(findobj(lowAxes, 'Type', 'text'))
    if strcmp(mainLayer,'bottom')
    ...
    xPoints = [mainXLim(1) mainXLim(2)];
    yPoints1 = ones(1,2)*(mainPosition(2) + lowHeightTemp);
    yPoints2 = ones(1,2)*(mainPosition(2) + mainPosition(4) - highHeightTemp);
