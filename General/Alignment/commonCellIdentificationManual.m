...
[spatial_footprints,number_of_sessions]=load_multiple_sessions(useFile_names);
[footprints_projections]=compute_footprints_projections(spatial_footprints);
plot_all_sessions_projections_YG(footprints_projections,figures_directory,figures_visibility)
disp('Done')
...
load([results_directory '\manualAlignment.mat'])
...
plot_x_y_displacements_YG(neighbors_x_displacements,neighbors_y_displacements,microns_per_pixel,normalized_maximal_distance,number_of_bins,centers_of_bins,figures_directory,figures_visibility);
disp('Part a done')
...
if strcmp(initial_registration_type,'Spatial correlation') % if spatial correlations are used
    ...
    if strcmp(imaging_technique,'two_photon')
        ...
        plot_initial_registration_YG(cell_to_index_map,number_of_bins,spatial_footprints_corrected,initial_registration_type,figures_directory,figures_visibility,registered_cells_spatial_correlations,non_registered_cells_spatial_correlations)
    end
    ...
    plot_initial_registration_YG(cell_to_index_map,number_of_bins,spatial_footprints_corrected,initial_registration_type,figures_directory,figures_visibility,registered_cells_centroid_distances,non_registered_cells_centroid_distances,microns_per_pixel,normalized_maximal_distance)
end
...
if strcmp(registration_approach,'Probabilistic')    
    ...
    plot_cell_scores_YG(cell_scores_positive,cell_scores_negative,cell_scores_exclusive,cell_scores,p_same_registered_pairs,figures_directory,figures_visibility)
...
plot_all_registered_projections_YG(spatial_footprints_corrected,optimal_cell_to_index_map,figures_directory,figures_visibility)
