...
% load activity
load('data/model_vB/activityData_DS_PS_vB.mat','activityData','mouseSubSamples')
...
for cc = 1:length(cellTypes)
    ...
    save(['data/model_vB/corrDataDS_' cellTypes{cc} '_vB.mat'],'corrData','corrLabels','mouseSubSamples')
end
