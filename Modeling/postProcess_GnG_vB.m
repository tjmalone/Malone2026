...
for cc = 1:length(cellTypes)
    ...
    useGroupIdx = ismember(tbl.fGeno,genoGroups{useGroup});
    ...
    tblNaN = tbl(useGroupIdx,[8:9 11:12]);
    ...
    save(['data/model_vB/LOOCVplot_' modelType '_' groupSaveName{useGroup} svSupp...
        '_' cellTypes{cc} '_GnG_vB.mat'],'LOOData','dataProcessed','nTrials','tblNaN')
end
