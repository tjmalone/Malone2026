...
for ff = 1:nFOV
    ...
    for rr = 1:nROI
        ...
        curMatchIdx = find(curIdents(distsIdx(:,rr))==curIdents(rr));
...
save('Z:\labMembers\TM\AD_Project\Revision\Histology\histologyValidation\histClusteringType_putB.mat','dataCluster')


%% Plot combined data

clear; close all; clc
load('Z:\labMembers\TM\AD_Project\Revision\Histology\histologyValidation\histClusteringType_putB.mat','dataCluster')
